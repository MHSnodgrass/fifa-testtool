...
export const getEventsByStage = (stage: Stage) => apiFetch<EventResponse[]>(`api/events/stage/${stage}`);
export const getAllTeams = () =>  apiFetch<TeamResponse[]>(`/api/teams`);
export const getTeamsByGroup = (group: Group) => apiFetch<TeamResponse[]>(`/api/teams/group/${group}`);