    ...
    <div className="border-l-4 border-primary-container bg-surface-container-lowest w-full p-6 flex flex-wrap items-end gap-6">
      ...
      <div className="flex-1 min-w-50">
        <label
          ...
          className="text-[0.6875rem] text-secondary mb-1 font-bold tracking-widest block uppercase"
        >
          Filter
        </label>
      ...
      <div className="flex-1 min-w-50">
        <label className="text-[0.6875rem] text-secondary mb-1 font-bold tracking-widest block uppercase">
          Dates
        </label>
